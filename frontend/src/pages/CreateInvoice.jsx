...
export default function CreateInvoice() {
  ...
  const handleSubmit = async () => {
    ...
    setLoadingStatus("Creating invoice...");
    ...
    try {
      ...
      setLoadingStatus("Transforming invoice...");
      ...
      setLoadingStatus("Validating invoice...");
      await fetch(
  ...
  return (
    <>
      ...
      {(extracting || loadingStatus) && (
        <LoadingOverlay
          message={extracting ? "Extracting invoice data..." : loadingStatus}
        />
      )}
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-200 dark:border-gray-700 p-6 mb-6 transition-colors duration-300">
            ...
            <input
              ...
              disabled={!!loadingStatus || extracting}
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-200 dark:border-gray-700 p-8 transition-colors duration-300">
            ...
            <h3 className="text-md font-medium text-gray-600 dark:text-gray-400 mb-3 mt-2">
              Supplier Contact
            </h3>
            <input
              className={inputClass}
